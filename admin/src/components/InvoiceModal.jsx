...
/**
 * Print-friendly invoice for a purchase transaction.
 * On screen it follows the brutalist workbench theme; when printed, a scoped
 * stylesheet (body.printing-invoice) hides the app chrome and renders only
 * #invoice-print-area.
 */
  ...
  return (
    <div className="fixed inset-0 z-50 bg-ink/70 flex items-center justify-center p-4 overflow-y-auto">
      <div id="invoice-modal-card" className="modal-card max-w-3xl">
        ...
        <div className="print:hidden px-6 py-4 border-b-2 border-ink flex items-center justify-between bg-ink">
        ...
        <div id="invoice-print-area" className="bg-white">
          {/* Masthead */}
          ...
          {/* Meta grid */}
          <div className="px-7 py-6 grid grid-cols-1 sm:grid-cols-2 gap-6 border-b-2 border-ink/15 break-inside-avoid">
            {/* Billed by */}
            <div>
            ...
            {/* Invoice meta */}
            <div className="sm:col-span-2 grid grid-cols-2 sm:grid-cols-4 gap-4 pt-1">
              <div>
          ...
          <div className="px-7 py-6">
            ...
            <div className="flex justify-end mt-5">
              <div className="w-full sm:w-72 space-y-2 text-sm break-inside-avoid">
                {amount > 0 ? (
                  <>
            ...
            {/* Payment trail */}
            <div className="mt-6 pt-4 border-t-2 border-ink/15 grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div>
        ...
        <div className="print:hidden px-6 py-3.5 border-t-2 border-ink bg-paper-50 flex items-center justify-between gap-3">
          <button
            type="button"
            onClick={copyId}
